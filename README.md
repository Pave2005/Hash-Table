...
"Заселенность" хэш-таблицы будет показана с помощью [гистограмм](https://www.apple.com/numbers/). По горизонтали указан номер подмножества таблицы. По вертикали количество элементов в соответствующем подмножестве.
...
Как можно увидеть из отчета ниже, ```MurmurHash``` является максимальной по времени работы среди остальных функций, если не считать функцию поиска.
...
Ниже приведена [гистограмма](https://www.apple.com/numbers/) распределения в хэш-таблице.
